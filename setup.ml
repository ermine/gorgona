...
(* OASIS_START *)
(* DO NOT EDIT (digest: 0c781288b1346da958fdb972c6f849ac) *)
(*
...
let setup_t =
  {
            ...
            [
               Library
                 ({
                     ...
                     },
                   {
                      ...
                      bs_build_depends =
                        [
                           FindlibPackage ("erm_xml", None);
                           FindlibPackage ("erm_xmpp", None);
                   ...
                   {
                      lib_modules =
                        ["Grgn_config"; "Grgn_xmpp"; "Grgn_muc"; "Grgn_ooc"];
                      lib_pack = false;
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "gorgona.ml"; });
               SrcRepo
                 ({
                     cs_name = "github";
                     cs_data = PropList.Data.create ();
                     ...
                     },
                   {
                      src_repo_type = Git;
                      src_repo_location =
                        "git://github.com/ermine/gorgona.git";
                      src_repo_browser =
                        Some "https://github.com/ermine/gorgona";
     ...
     oasis_version = "0.3.1";
     oasis_digest = Some "zx*R\014M\016\016Ý†)­!\027•@";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
